...
%     [P.spls, P.corresp] = find_corresp(P.cpts, P.sample_ratio);
%     P.spls_adj = connect_by_inherit_neigh(P.cpts, P.spls, P.corresp, P.rings); 
%     edge_collapse_simple(P.spls, P.spls_adj, options);
else
    [P.spls,P.corresp] = farthest_sampling_by_sphere(P.cpts, P.sample_radius);
    P.spls_adj = connect_by_inherit_neigh(P.cpts, P.spls, P.corresp, P.rings);
...
%%
if (SHOW_RESULTS)
    figure('Name','lineextract'); 
    movegui('northeast');set(gcf,'color','white');hold on;
